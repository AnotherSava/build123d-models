...
from build123d import Axis, Plane, Shape, Solid, Vector
...
class SmartCone(SmartSolid):
    def __init__(self, solid: Shape, radius_outer: float, radius_top: float, cone_angle: float, thickness: float = None, base_angle: float = None) -> None:
    ...
    @property
    def height_higher_inner(self) -> float:
    ...
    @property
    def height_lower_outer(self) -> float:
    ...
    @property
    def height_lower_inner(self) -> float:
    ...
    @property
    def height_apex_higher(self) -> float:
    ...
    @classmethod
    def create_cone(cls, cone_angle: float, radius: float, top_radius: float = 0) -> 'SmartCone':
    ...
    def create_outer_cone(self, radius: float = None, radius_top: float = None) -> 'SmartCone':
    ...
    def create_inner_cone(self, radius: float = None, radius_top: float = None) -> 'SmartCone':
    ...
    def scale_radius_outer(self, factor: float | None, radius: float = None) -> 'SmartCone':
    ...
    def pad_outer(self, padding: float, radius: float = None) -> 'SmartCone':
    ...
    def create_axis(self, inner: bool = False) -> Axis:
