...
from sava.csg.build123d.common.smartercone import ConeSection, SmarterCone


class TestBuilderBase(unittest.TestCase):

    def test_base_creates_single_section(self) -> None:
    ...
    def test_base_with_plane_and_angle(self) -> None:
...
class TestBuilderCylinder(unittest.TestCase):
    ...
    def test_cylinder_creates_two_sections(self) -> None:
    ...
    def test_cylinder_bounding_box(self) -> None:
    ...
    def test_cylinder_with_angle(self) -> None:
...
class TestBuilderWithRadiusAndHeight(unittest.TestCase):
    ...
    def test_simple_cone(self) -> None:
    ...
    def test_cone_bounding_box(self) -> None:
        cone = SmarterCone.base(50).extend(radius=30, height=100)
    ...
    def test_cone_with_shift(self) -> None:
...
class TestBuilderWithAngleAndHeight(unittest.TestCase):
    ...
    def test_narrowing_cone(self) -> None:
...
class TestBuilderWithAngleAndRadius(unittest.TestCase):
    ...
    def test_narrowing_to_zero(self) -> None:
    ...
    def test_narrowing_to_specific_radius(self) -> None:
    ...
    def test_widening_cone(self) -> None:
...
class TestBuilderWithHeight(unittest.TestCase):
    ...
    def test_cylindrical_extension(self) -> None:
...
class TestMultiSection(unittest.TestCase):
    ...
    def test_three_sections_with_shift(self) -> None:
        cone = SmarterCone.base(10).extend(radius=15, height=50).extend(radius=20, height=50, shift_x=5)
        self.assertAlmostEqual(cone.z_max, 100, places=1)

    def test_three_sections_with_inner_radius(self) -> None:
        cone = SmarterCone([
    ...
    def test_mixed_inner_radius(self) -> None:
    ...
    def test_angle_less_than_360(self) -> None:
        cone = SmarterCone([
            ConeSection(20, 0),
            ConeSection(30, 50),
            ConeSection(25, 100),
...
class TestValidation(unittest.TestCase):
    ...
    def test_first_section_height_must_be_zero(self) -> None:
    ...
    def test_inner_radius_must_be_less_than_outer(self) -> None:
        with self.assertRaises(AssertionError):
            SmarterCone([ConeSection(10, 0, inner_radius=15), ConeSection(20, 50, inner_radius=10)])

    def test_non_monotonic_heights_rejected(self) -> None:
        with self.assertRaises(AssertionError):
...
class TestProperties(unittest.TestCase):
    ...
    def test_height_two_sections(self) -> None:
        cone = SmarterCone.base(50).extend(radius=30, height=100)
        self.assertAlmostEqual(cone.height, 100)

    def test_height_single_section(self) -> None:
        cone = SmarterCone.base(50)
        self.assertAlmostEqual(cone.height, 0)

    def test_base_radius(self) -> None:
        cone = SmarterCone.base(50).extend(radius=30, height=100)
        self.assertAlmostEqual(cone.base_radius, 50)

    def test_top_radius(self) -> None:
        cone = SmarterCone.base(50).extend(radius=30, height=100)
        self.assertAlmostEqual(cone.top_radius, 30)

    def test_has_inner_false(self) -> None:
        cone = SmarterCone.base(50).extend(radius=30, height=100)
        self.assertFalse(cone.has_inner)

    def test_has_inner_true(self) -> None:
...
class TestRadiusPosition(unittest.TestCase):
    ...
    def test_two_section_cone(self, position, expected_radius) -> None:
        cone = SmarterCone.base(50).extend(radius=30, height=100)
    ...
    def test_three_section_cone(self, position, expected_radius) -> None:
        cone = SmarterCone.base(10).extend(radius=20, height=50).extend(radius=15, height=50)
        self.assertAlmostEqual(cone.radius(position), expected_radius, places=3)
    ...
    def test_single_section_raises(self) -> None:
        cone = SmarterCone.base(50)
        with self.assertRaises(AssertionError):
            cone.radius(0.5)
...
class TestCenterPosition(unittest.TestCase):
    ...
    def test_no_shift(self, position, expected) -> None:
        cone = SmarterCone.base(50).extend(radius=30, height=100)
    ...
    def test_with_shift(self, position, expected) -> None:
    ...
    def test_three_sections_with_shift_on_last(self, position, expected) -> None:
...
class TestCreateOffset(unittest.TestCase):
    ...
    def test_multi_section_offset(self) -> None:
        cone = SmarterCone.base(10).extend(radius=20, height=50).extend(radius=15, height=50)
    ...
    def test_offset_rejects_negative_radius(self) -> None:
...
class TestCreateShell(unittest.TestCase):
    ...
    def test_positive_shell_outer(self) -> None:
        cone = SmarterCone.base(50).extend(radius=30, height=100)
    ...
    def test_negative_shell_inner(self) -> None:
        cone = SmarterCone.base(50).extend(radius=30, height=100)
        shell = cone.create_shell(-2)
    ...
    def test_multi_section_shell(self) -> None:
        cone = SmarterCone.base(10).extend(radius=20, height=50).extend(radius=15, height=50)
    ...
    def test_rejects_already_hollow(self) -> None:
        cone = SmarterCone([ConeSection(20, 0, inner_radius=10), ConeSection(30, 50, inner_radius=20)])
        with self.assertRaises(AssertionError):
            cone.create_shell(2)
...
class TestFillettability(unittest.TestCase):
    ...
    def test_three_section_fillettable_at_junction(self) -> None:
    ...
    def test_three_section_with_inner_radius_valid(self) -> None:
