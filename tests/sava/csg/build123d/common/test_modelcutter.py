...
from build123d import Box, Line, Wire
from parameterized import parameterized

from sava.csg.build123d.common.geometry import create_wire_tangent_plane
from sava.csg.build123d.common.modelcutter import CutSpec, _calculate_triangle_size, _create_cutting_triangle_at_wire, cut_with_wires
...
class TestTriangleSizeCalculation(unittest.TestCase):
    ...
    def test_calculate_size_with_wire(self) -> None:
    ...
    def test_calculate_size_wire_far_from_model(self) -> None:
    ...
    def test_calculate_size_various_shapes(self, name, box) -> None:
...
class TestTriangleCreation(unittest.TestCase):
    ...
    def test_triangle_has_right_angle(self) -> None:
    ...
    def test_triangle_legs_at_45_degrees(self) -> None:
...
class TestSingleWireCut(unittest.TestCase):
    ...
    def test_cut_box_center_wire_x(self) -> None:
    ...
    def test_cut_box_center_wire_y(self) -> None:
    ...
    def test_cut_box_diagonal_wire(self) -> None:
...
class TestMultipleWiresCut(unittest.TestCase):
    ...
    def test_two_perpendicular_wires(self) -> None:
    ...
    def test_three_orthogonal_wires(self) -> None:
...
class TestEdgeCases(unittest.TestCase):
    ...
    def test_empty_wire_list(self) -> None:
    ...
    def test_wire_outside_model(self) -> None:
    ...
    def test_multiple_wires_some_outside(self) -> None:
    ...
    def test_piece_entirely_consumed_by_cutter(self) -> None:
    ...
    def test_single_point_on_edge(self) -> None:
...
class TestGeometricCorrectness(unittest.TestCase):
    ...
    def test_all_pieces_are_valid(self) -> None:
    ...
    def test_pieces_volume_conservation(self) -> None:
...
class TestThicknessCutting(unittest.TestCase):
    ...
    def test_cut_with_thickness_removes_material(self) -> None:
    ...
    def test_cut_with_zero_thickness_same_as_thin_cut(self) -> None:
    ...
    def test_larger_thickness_removes_more_material(self) -> None:
